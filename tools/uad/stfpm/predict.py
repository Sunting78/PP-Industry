...
def argsparser():
    ...
    parser.add_argument("--img_path", type=str, default=None, help="picture path")
    parser.add_argument('--resize', type=list, default=None)
    parser.add_argument("--backbone", type=str, default=None)
    parser.add_argument("--model_path", type=str, default=None, help="student model_path")
...
def main():
    ...
    for j in range(len(t_feat)):
        ...
        sm = F.interpolate(sm, size=(args.resize[0], args.resize[1]), mode='bilinear', align_corners=False)
    ...
    if args.save_pic:
        ...
        plot_fig(img.numpy(), score_map.squeeze(1), None, args.threshold, save_name, args.category, args.save_pic, 'predict')
